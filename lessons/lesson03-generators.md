...
- Reading: [Urbit Org, "Walkthrough:  List of Numbers"](https://urbit.org/docs/hoon/hoon-school/list-of-numbers/)
- Reading: [Urbit Org, "Gates"](https://urbit.org/docs/hoon/hoon-school/gates/) (you should complete the exercises there as well)
...
- Reading: [Urbit Org, "Generators"](https://urbit.org/docs/hoon/hoon-school/generators/), section "Naked Generators"
- Reading: [Urbit Org, "Walkthrough:  Recursion"](https://urbit.org/docs/hoon/hoon-school/recursion/) (note in particular the better way to carry out recursion)
